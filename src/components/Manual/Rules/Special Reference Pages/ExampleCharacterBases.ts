...
export const IronBlade = {
  ...
  abilitiesDesciption:
    '<p>This character put two ranks in Heavy Weapons, two ranks in Swords, took the Martial Perk Mitigative-1, and put one rank in Fitness</br></br>On a standard round of combat, this character might decide to attack with their sword investing all their MP into their Swords Skill Lethal IV. They would make a roll to hit and If their Perception roll exceeds or meets the targets dvs deal (2d8 base damage of their bastard sword) + 8 (from the 2 ranks in Lethal IV). Note that MP regenerates every round, so they may do this attack each turn.</br></br>Another powerful ability they have is the Mitigative perk, this lets them reactionarily boost DVS, reduce damage, or take a hit for someone else.   </br></br> You can reference a mock of the characters overview page in the overview tab in this very example! </br> </br></p>',
  stats: {
    ...DEFAULT_EXAMPLE_CHARACTER,
    attributes: {
      strength: 7,
